...
P_list = [np.mean(P_L_s[1:]), np.mean(P_L_feedback[1:]), np.mean(P_L_delay[1:])]
color_list = ['C0', 'C1', 'C2']
lifetimes = []
errs = []
...
ax.text(65000, 0.38,rf'$T_L ={lifetimes[0]/1000:.1f}$ μs,  $P_L={P_list[0]:.2f}$', color='C0')
ax.text(88000, 0.34,rf'$T_L ={lifetimes[1]/1000:.1f}$ μs,  $P_L={P_list[1]:.2f}$', color='C1')
ax.text(45000, 0.56,rf'$T_L ={lifetimes[2]/1000:.1f}$ μs,  $P_L={P_list[2]:.2f}$', color='C2')
